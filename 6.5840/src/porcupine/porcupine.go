...
// CheckOperationsTimeout timeout = 0 means no timeout
...
// CheckOperationsVerbose CheckOperationsVerbose timeout = 0 means no timeout
// if this operation times out, then a false positive is possible
...
// CheckEventsTimeout timeout = 0 means no timeout
// if this operation times out, then a false positive is possible
...
// CheckEventsVerbose timeout = 0 means no timeout
// if this operation times out, then a false positive is possible
